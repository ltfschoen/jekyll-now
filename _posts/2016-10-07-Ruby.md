...
* Blocks are an additional parameter passed to the method
...
* Custom Iterator Methods using Enumerators 

TODO - Passing Iterator into a Method
TODO - Iteratve over two collections in parallel
